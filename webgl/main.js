var Pyrite = (function () {
    function Pyrite() {
        ...
        if (queries['displayname']) {
            this.displayname = queries['displayname'];
        }
    ...
    Pyrite.prototype.addControls = function(container) {
        ...
        // set the set name
        var setNameLabel = document.createElement('label');
        setNameLabel.name = 'setName';
        setNameLabel.innerText = this.displayname;
        setNameLabel.style.position = 'absolute';
        setNameLabel.style.top = '30px';
        setNameLabel.style.right = '50px';
        setNameLabel.style.zIndex = '100';
        setNameLabel.style.color = 'white';
        setNameLabel.style.backgroundColor = 'gray';
        setNameLabel.style.fontSize = '20px';
        setNameLabel.style.padding = '5px';
        container.appendChild(setNameLabel);
